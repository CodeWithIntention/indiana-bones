...
const CHARACTERS = {
    ...
    cat:        {points: 1000, priority: 3, speed: -40, lives: 0, qty: (level => Math.floor(level/2)+1), 
    ...
    mouse:      {points: 2000, priority: 3, speed: -40, lives: 0, qty: (level => level-2), 
                    ...
                    rotationTransform: [[Direction.UP, 90], [Direction.DOWN, 270], [Direction.LEFT, 0], [Direction.RIGHT, -180]]},
    monkey:     {points: 3000, priority: 3, speed: -40, lives: 0, qty: (level => level-4), 
                    ...
                    rotationTransform: [[Direction.UP, 90], [Direction.DOWN, 270], [Direction.LEFT, 0], [Direction.RIGHT, -180]]},
    rat:        {points: 4000, priority: 3, speed: -40, lives: 0, qty: (level => level-6), 
                    isChompable: true, isGrabable: true, grabSound: "grab", chompSound: "eat",
